...
- **No native WebRTC transport** by design: relay-ipfs uses TCP only to avoid the node-datachannel native build hazard. Public gateways and Kubo nodes all support TCP so this is rarely a limitation in practice.
