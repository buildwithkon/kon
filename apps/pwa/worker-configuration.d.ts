/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0acb10347a1ca07b6314401c3f02fa4d)
// Runtime types generated with workerd@1.20250525.0 2025-02-24 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    ENV: 'staging' | 'production'
    WC_PROJECT_ID: string
    XMTP_ENCRYPTION_KEY: string
    ALCHEMY_API_KEY: string
    CDP_CLIENT_API_KEY: string
    ALCHEMY_API_KEY: SecretsStoreSecret
    CDP_CLIENT_API_KEY: SecretsStoreSecret
    API_WORKER: Fetcher /* kon-api-staging */
  }
}
