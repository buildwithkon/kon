...
function ToastButton() {
  ...
  return (
    <button
      type="button"
      className="focus-visible:-outline-offset-1 box-border flex h-10 select-none items-center justify-center rounded-md border border-gray-200 bg-gray-50 px-3.5 py-0 font-medium text-gray-900 outline-0 hover:bg-gray-100 focus-visible:outline-2 focus-visible:outline-blue active:bg-gray-100"
      onClick={createToast}
    >
      Create toast
    </button>
...
function ToastList() {
  ...
  return toasts.map((toast) => (
    ...
    >
      ...
      <Toast.Description className="text-[0.925rem] text-gray-700 leading-5" />
      <Toast.Close
